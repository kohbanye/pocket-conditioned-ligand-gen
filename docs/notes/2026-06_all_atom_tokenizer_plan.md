...
- Vina/obabel/prepare_receptor: `/home/5/uq02055/.local/bin/vina`,
  ...
  (One machine's layout, recorded as it was. Code never hard-codes these --
  `prolit.external_tools` resolves them from PATH and the environment at run
  time, so on another host you set the environment rather than edit anything.)
