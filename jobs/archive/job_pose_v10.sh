...
# Train + eval a pose head on the v10 corpus (v8 + per-atom displacement labels
...
.venv/bin/python pipelines/train/head.py \
    ...
    --max-epochs 5 --micro-batch-size 32 --early-stop-patience 2 \
