...
RMSNorm, SwiGLU, RoPE, QK-Norm) sized from :class:`~src.config.LigandLMConfig`.
...
from src.tokenizers.lm_vocab import BOS_ID, EOS_ID, PAD_ID

if TYPE_CHECKING:
    from src.config import LigandLMConfig
