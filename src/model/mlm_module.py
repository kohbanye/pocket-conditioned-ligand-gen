...
Wraps the ESM masked-LM (:func:`src.model.complex_mlm.build_esm_mlm`) with a
...
context. The optimizer/schedule mirrors :class:`~src.model.lm_module.LigandLMModule`.
"""
...
from src.data.mlm_dataset import IGNORE_INDEX
