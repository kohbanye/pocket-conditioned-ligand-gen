...
Kept out of :mod:`recon_bench.metrics` on purpose -- that module is pure NumPy and
...
def prefetch(jobs: Sequence[tuple], workers: int | None = None) -> int:
    ...
    # raise it with RECON_BENCH_PB_WORKERS.
    env_workers = os.environ.get("RECON_BENCH_PB_WORKERS")
