...
the MLM pseudo-log-likelihood; metrics live in :mod:`ctbench.metrics.affinity`.
"""
...
if TYPE_CHECKING:
    ...
    from ctbench.config import AffinityConfig, PathsConfig
    from ctbench.variants import AffinityCkpts
